...
type UserServiceClient interface {
	...
	GetAllUser(ctx context.Context, in *GetAllUserRequest, opts ...grpc.CallOption) (*GetUserAllResponse, error)
...
func (c *userServiceClient) GetAllUser(ctx context.Context, in *GetAllUserRequest, opts ...grpc.CallOption) (*GetUserAllResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	GetAllUser(context.Context, *GetAllUserRequest) (*GetUserAllResponse, error)
...
func (UnimplementedUserServiceServer) GetAllUser(context.Context, *GetAllUserRequest) (*GetUserAllResponse, error) {
